...
function getCard() {
  return $(
    '<div class="card shadow mb-4 "><div class="card-header price-bar" ></div><div class="card-body"><p class="text-rainbow text-center"></p></div><div class="card-footer operate-bar" ><div class="row"><button class="col buy-bar btn"> BUY </button> <button class="col sell-bar btn"> SELL </button> </div></div></div>'
  );
}
